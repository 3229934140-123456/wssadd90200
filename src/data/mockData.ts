...
const demoSurgeryPlan: SurgeryPlan = {
  ...
  tabooNotes: '拆线前伤口绝对不能沾水；不要用手摸伤口；术后1个月内避免辛辣、酒精、海鲜；不要剧烈运动；不要蒸桑拿、游泳。',
...
const demoNurseNotes: NurseFollowUpNote[] = [
  {
    ...
    date: '2026-06-19',
    nurseName: '王护士',
    recoveryStatus: '术后第1天，双眼肿胀明显，右眼较左眼稍重，伤口干燥无渗液，无疼痛发热。',
    nextNotes: '继续冷敷，每次15分钟，间隔1小时。保持伤口干燥，不要沾水。按时吃消炎药。如有剧痛或出血立即联系。',
    nextSteps: '继续冷敷，每次15分钟，间隔1小时。保持伤口干燥，不要沾水。按时吃消炎药。如有剧痛或出血立即联系。',
  ...
  },
  {
    ...
    nextSteps: '可以开始温热敷帮助淤青吸收，温度不要太高。继续清淡饮食，不要熬夜。6月25日上午10点拆线，请提前到院。',
...
export const defaultSurgeryPlan: SurgeryPlan = {
  ...
  tabooNotes: '拆线前伤口不能沾水；不要用手触摸伤口；术后1个月内禁食辛辣、酒精、海鲜；避免剧烈运动；不要蒸桑拿、游泳。',
